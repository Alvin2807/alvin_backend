...
class VistaDetalleOrdenCompra extends Model
{
    use HasFactory;
    ...
    'no_factura','fecha_factura','sub_total','itbms','total','estado_detalle','cantidad_pedida','cantidad_recibida','cantidad_almacen','localizacion','cantidad_sitio','en_almacen',
    'en_sitio','fk_unidad_medida','fk_localizacion'];
